                        ...
                        <form action="" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for=""></label>
                                        <input type="submit" class="btn btn-primary" value="<?php echo  $languages[149]; ?>" name="form1">
                                    </div>
                                </div>
                            </div>                        
                        </form>

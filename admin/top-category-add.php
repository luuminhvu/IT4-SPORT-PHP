...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục top không được để trống<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Tên danh mục top đã tồn tại<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Danh mục top đã được thêm thành công.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Tên danh mục top <span>*</span></label>
							<div class="col-sm-4">

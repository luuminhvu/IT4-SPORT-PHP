...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
    	...
    	$valid = 0;
        $error_message .= 'Bạn phải chọn một ảnh sản phẩm<br>';
    }
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Tên danh mục đầu<span>*</span></label>
							<div class="col-sm-4">
								<select name="tcat_id" class="form-control select2 top-cat">
									<option value="">Chọn tên danh mục đầu</option>
									<?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Tên danh mục giữa <span>*</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="mnu_id" class="form-control select2">
									...
									foreach ($result as $row) {
										?>
										<option value="<?php echo $row['mnu_id']; ?>"><?php echo $row['mnu_name']; ?></option>
										<?php
									}
									?>
								</select>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ảnh sản phẩm chính <span>*</span></label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Chính sách</label>
							<div class="col-sm-8">

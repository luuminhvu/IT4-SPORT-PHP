						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									...
									<td><?php echo $row['tcat_name']; ?><br><?php echo $row['mcat_name']; ?><br><?php echo $row['mcat_name']; ?></td>
									<td>										
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Hãy cẩn thận! Sản phẩm này sẽ bị xóa khỏi bảng đặt hàng, bảng thanh toán, bảng size, bảng màu và bảng xếp hạng.</p>
            </div>

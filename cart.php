...
if (isset($_POST['form1'])) {
    ...
    for ($i = 1; $i <= count($arr1); $i++) {
        ...
        if ($table_quantity[$temp_index] < $arr2[$i]) {
            ...
            $error_message .= '"Trong kho chỉ có "' . $table_quantity[$temp_index] . ' ' . $arr3[$i] . '"\n';
        } else {
...
?>
    ...
    <?php else : ?>
        <script>
            alert('Cập nhật số lượng các mặt hàng thành công!');
        </script>
    <?php endif; ?>
<?php
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if (!isset($_SESSION['cart_p_id'])) : ?>
                    ...
                    <?php echo '<h4 class="text-center">
                        Thêm sản phẩm vào giỏ hàng để xem tại đây.</h4>'; ?>
                <?php else : ?>
